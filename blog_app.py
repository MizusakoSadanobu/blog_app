...
class BlogApp:
    ...
    def run(self):
        if st.session_state['user']:
            ...
            login_option = st.sidebar.radio("Edit/Logout/Manage Users", ("Edit", "Manage Users"))
        ...
        if st.button("Register"):
            if username and password and (admin_password == ADMIN_PASSWORD):
                ...
                if existing_user:
                    ...
                    new_user = User(username=username, password_hash=User.hash_password(password), is_admin=True)
    ...
    def manage_users(self):
        ...
        if st.session_state['user'].is_admin:
            ...
            for user in users:
                ...
                pushed = st.button(f"Delete {user.username}", key=f"delete_user_{user.id}")
